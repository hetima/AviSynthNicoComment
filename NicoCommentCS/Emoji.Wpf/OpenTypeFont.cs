...
using NCTypography.OpenFont;
using NCTypography.TextLayout;
...
namespace NCEmoji.Wpf
{
    public class EmojiTypeface
    {
        ...
        public bool RenderGlyph(DrawingContext dc, ushort gid, Point origin, double size, Brush fallback_brush)
    ...
    internal class ColorTypeface
    {
        public ColorTypeface(string name)
        {
            ...
            {
                var r = new NCTypography.OpenFont.OpenFontReader();
                m_openfont = r.Read(s, 0, NCTypography.OpenFont.ReadFlags.Full);
            }
        ...
        protected NCTypography.OpenFont.Typeface m_openfont;
